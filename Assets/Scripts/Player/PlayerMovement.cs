...
public class PlayerMovement : MonoBehaviour
{
    ...
    void SetPlayerState()
    {
        ...
        else if ((currentState == PlayerState.sliding||currentState==PlayerState.slideJump)&&flatVel.magnitude>runMaxSpeed) 
        {
    ...
    Vector3 SlopeAcceleration()
    {
       ...
       return Vector3.ProjectOnPlane(Vector3.down, slopeHit.normal).normalized * slopeAcceleration*angleMultiplier;
    }
    void SpeedControl()
    {
